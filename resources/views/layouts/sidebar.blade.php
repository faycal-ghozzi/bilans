<div class="bg-btlGreen w-64 h-screen fixed top-[4rem]">
    <nav class="py-6">
        <ul class="space-y-4">
            ...
            <li>
                <a href="{{-- route('financial-statement.show', ['id' => $id, 'date => $date']) --}}" class="flex items-center px-4 py-4 hover:bg-btlRed hover:text-white text-btlGreen bg-white">
