<div class="bg-btlGreen w-64 h-screen fixed top-[4rem]">
    <nav class="py-6">
        <ul class="space-y-4">
            <li>
                <a href="{{ route('financial-statement.show', ['id' => $id]) }}" 
                   class="flex items-center px-4 py-4 hover:bg-btlRed hover:text-white {{ Route::is('financial-statement.show') ? 'text-btlGreen bg-white' : 'text-white'}}">
            ...
            <li>
                <a href="{{ route('financial.analysis', ['id' => $id]) }}" 
                   class="flex items-center px-4 py-4 hover:bg-btlRed hover:text-white {{ Route::is('financial.analysis') ? 'text-btlGreen bg-white' : 'text-white'}}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <!-- Ratios Icon -->
            ...
            <li>
                <a href="{{ route('financial-statement.download', ['id' => $id]) }}" 
                   class="flex items-center px-4 py-4 text-white hover:bg-btlRed hover:text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <!-- Download Icon -->
